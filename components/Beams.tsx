...
const Beams = ({
  beamWidth = 2,
  beamHeight = 15,
  beamNumber = 10,        // reduced from 12 for perf
  lightColor = "#ffffff",
  speed = 2,
  noiseIntensity = 1.75,
  scale = 0.2,
...
gl_FragColor.rgb-=randomNoise/15.*uNoiseIntensity;`,
  ...
  return (
    // dpr capped at 1.5 (vs 2) to save GPU on high-DPI screens
    <Canvas dpr={[1, 1.5]} frameloop="always" className="w-full h-full" style={{ background: '#000' }}>
